...
{
    /**
     * @param string|array<string,mixed>|mixed $locale
     */
    ...
    public static function collectLocales(App $kirby): array
    {
        ...
        $push = function (mixed $locale, string $source = 'plugin', ?string $defaultGroup = null) use (&$collected, &$seen): void {
    ...
    public static function canonicaliseLocaleTag(?string $value): string
    {
        ...
        if (class_exists(\Locale::class) && method_exists(\Locale::class, 'canonicalize')) {
            try {
